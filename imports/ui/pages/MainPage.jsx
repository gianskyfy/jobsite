...
export default class MainPage extends Component {
  ...
  render() {
    return (
      <div>
      <div class="intro-banner" data-background-image="/src/assets/images/home-background.jpg">
      	<div class="container">
      			...
      			<div class="col-md-12">
      				<div class="banner-headline">
      					<h3>
      						...
      						<br/>
      						<span>Thousands of small businesses use <strong class="color">Salesfy</strong> to turn their ideas into reality.</span>
      					</h3>
      				</div>
      			</div>
      		</div>
      	...
      	<div class="container">
      		<div class="row">
      			...
      			<div class="col-xl-3 col-md-6">
      				<a href="jobs-list-layout-1.html" class="photo-box" data-background-image="/src/assets/images/featured-city-01.jpg">
      			...
      			<div class="col-xl-3 col-md-6">
      				...
      				<a href="jobs-list-layout-full-page-map.html" class="photo-box" data-background-image="/src/assets/images/featured-city-02.jpg">
      					<div class="photo-box-content">
      						<h3>New York</h3>
      						<span>645 Jobs</span>
      					</div>
      			...
      			<div class="col-xl-3 col-md-6">
      				...
      				<a href="jobs-grid-layout-full-page.html" class="photo-box" data-background-image="/src/assets/images/featured-city-03.jpg">
      					<div class="photo-box-content">
      						<h3>Los Angeles</h3>
      						<span>832 Jobs</span>
      					</div>
      			...
      			<div class="col-xl-3 col-md-6">
      				...
      				<a href="jobs-list-layout-2.html" class="photo-box" data-background-image="/src/assets/images/featured-city-04.jpg">
      					<div class="photo-box-content">
      						<h3>Miami</h3>
      						<span>513 Jobs</span>
      					</div>
      				...
      				<div class="default-slick-carousel freelancers-container freelancers-grid-layout">
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      							<div class="freelancer-overview-inner">
      								...
      								<div class="freelancer-name">
      									<h4><a href="single-freelancer-profile.html">Tom Smith <img class="flag" src="/src/assets/images/flags/sg.svg" alt="" title="United Kingdom" data-tippy-placement="top" /></a></h4>
      						...
      						<div class="freelancer-details">
      							<div class="freelancer-details-list">
      								<ul>
      									<li>Location <strong><i class="icon-material-outline-location-on"></i> Singapore</strong></li>
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      							<div class="freelancer-overview-inner">
      								...
      								<div class="freelancer-name">
      									<h4><a href="#">David Peterson <img class="flag" src="/src/assets/images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top" /></a></h4>
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      							<div class="freelancer-overview-inner">
      								...
      								<div class="freelancer-name">
      									<h4><a href="#">Marcin Kowalski <img class="flag" src="/src/assets/images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top" /></a></h4>
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      								...
      								<div class="freelancer-name">
      									<h4><a href="#">Sindy Forest <img class="flag" src="/src/assets/images/flags/au.svg" alt="" title="Australia" data-tippy-placement="top" /></a></h4>
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      								...
      								<div class="freelancer-name">
      									<h4><a href="#">Sebastiano Piccio <img class="flag" src="/src/assets/images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"/></a></h4>
      					...
      					<div class="freelancer">
      						...
      						<div class="freelancer-overview">
      								...
      								<div class="freelancer-name">
      									<h4><a href="#">Gabriel Lagueux <img class="flag" src="/src/assets/images/flags/fr.svg" alt="" title="France" data-tippy-placement="top" /></a></h4>
