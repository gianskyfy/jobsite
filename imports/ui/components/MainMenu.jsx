...
export default  class MainMenu extends Component {
    ...
    renderMenu()
    {
        ...
        return <ul data-submenu-title="Overview">
            ...
            <li className={currentPage.includes('/dashboard') ? 'active' : ''}><a href="/dashboard"><i className="icon-material-outline-dashboard"></i> Dashboard</a></li>
            <li className={ this.urlInclude(['applications', 'findjobs', 'viewjob', 'findcompanies'], currentPage) ? 'active-submenu' : ''}><a href="#"><i className="icon-material-outline-business-center"></i> Jobs</a>
                <ul>
                    ...
                    <li className={ this.urlInclude(['findcompanies'], currentPage)  ? 'active' : ''}><a href="/findcompanies">Find Companies</a></li>
                </ul>	
            </li>
        </ul>
        }
